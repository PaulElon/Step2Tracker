...
export const themes: Record<ThemeId, ThemeDefinition> = {
  ...
  paulblue: {
    id: "paulblue",
    label: "Paul Blue",
    description: "Rich deep blue with high-contrast white and cyan text.",
    chart: {
      text: "#e0f2fe",
      muted: "#7eb8d8",
      grid: "rgba(224,242,254,0.08)",
      outline: "rgba(224,242,254,0.16)",
      primary: "#38bdf8",
      secondary: "#67e8f9",
      tertiary: "#a78bfa",
      warm: "#fbbf24",
    ...
    lanes: {
      ...
      content: ["#38bdf8", "#67e8f9"],
      assessment: ["#fbbf24", "#f87171"],
      recovery: ["#7eb8d8", "#bfdbfe"],
      admin: ["#34d399", "#38bdf8"],
    },
  },
  teslared: {
    id: "teslared",
    label: "Tesla Red",
    description: "Matte black with signature Tesla red accents and white text.",
    chart: {
      text: "#f5f5f5",
      muted: "#a0a0a0",
    ...
    lanes: {
      review: ["rgba(227,25,55,0.28)", "rgba(255,77,100,0.18)"],
      content: ["rgba(227,25,55,0.22)", "rgba(255,143,160,0.14)"],
      assessment: ["rgba(255,149,0,0.22)", "rgba(255,200,100,0.14)"],
      recovery: ["rgba(160,160,160,0.18)", "rgba(245,245,245,0.10)"],
      admin: ["rgba(74,222,128,0.16)", "rgba(52,211,153,0.10)"],
    },
  },
};
