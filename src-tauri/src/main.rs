...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tf_autotracker_v2_native::tf_autotracker_v2_native_shadow_start,
            tf_autotracker_v2_native::tf_autotracker_v2_native_shadow_stop,
            tf_autotracker_v2_native::tf_autotracker_v2_native_shadow_status,
